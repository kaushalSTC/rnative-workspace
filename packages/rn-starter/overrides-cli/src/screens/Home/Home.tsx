...
const Home = ({navigation}: HomeScreenProps)=> {
    ...
    return(
        <>
            ...
            <Text style={styles.heading}>🚀 STC CLI Starter</Text>
            <Text style={styles.welcome}>Welcome to your new React Native CLI app!</Text>
...
• Light/Dark mode with responsive design</Text>
            ...
            <View style={styles.footer}>
                <Text style={styles.footerText}>🏢 Built with STC CLI Starter Template</Text>
